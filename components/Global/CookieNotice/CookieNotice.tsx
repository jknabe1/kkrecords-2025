...
export default function CookieConsent() {
  ...
  return (
    <div className="px-2 py-3 lg:px-5">
      <div className="fixed bottom-0 left-0 md:bottom-2 md:left-5 right-0 lg:right-auto z-[99] border border-solid border-black dark:border-neutral-700">
        <div className="w-full lg:max-w-[480px] bg-white dark:bg-neutral-900 text-black dark:text-white overflow-hidden">
